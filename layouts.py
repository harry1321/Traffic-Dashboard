...
tabs = dcc.Tabs([
        dcc.Tab(label='Fundamental Diagram',value='Fundamental-Diagram',style=tab_style, selected_style=tab_selected_style),
        dcc.Tab(label='Speed Flow Diagram',value='Speed-Flow-Diagram',style=tab_style, selected_style=tab_selected_style),
        dcc.Tab(label='Hour of Day Traffic Pattern',value='Hour-of-Day-Traffic-Pattern',style=tab_style, selected_style=tab_selected_style),
],value='Fundamental-Diagram',id='graphtabs',style=tabs_styles)
